<template>
    <div
        ...
        <input v-model="email" type="email" placeholder="seu@email.com"
            class="w-full p-2 bg-bg outline-none rounded-md text-text" />
        <button
            class="w-full bg-accent p-1 rounded-md font-bold text-xl hover:bg-accent-hover transition-all duration-100 ease-in text-white">Cadastrar</button>
    </div>
</template>
